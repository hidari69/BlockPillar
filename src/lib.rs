...
#[derive(Debug)]
pub struct BlockPillarProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockPillarProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockPillar processing");
    
    let mut processor = BlockPillarProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockPillarProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockPillarProcessor::new(false);
